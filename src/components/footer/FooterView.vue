<template>
    <footer>
        <div class="z-1000 flex flex-col justify-center items-center bg-[#ed9121]/80 w-full px-4 py-8 text-white shadow-md space-y-4 md:space-y-0">
        ...
        <div class="flex items-center justify-center space-x-3 w-full">
            ...
            <div class="flex items-center justify-center space-x-3 w-full">
                <p class="text-base md:text-lg">© All Rights Reserved</p>
            </div>
        </div>
    </footer>
</template>